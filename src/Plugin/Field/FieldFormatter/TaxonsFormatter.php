...
/**
 * Plugin implementation of the 'taxons' formatter.
 *
 * @FieldFormatter(
 *   id = "taxons_formatter",
 ...
 * )
 */
class TaxonsFormatter extends EntityReferenceFormatterBase
{
  /**
   * {@inheritdoc}
   */
  ...
  public function viewElements(FieldItemListInterface $items, $langcode)
  {
    ...
    $active_tags = $node->get($field_name)->getValue();
    ...
    foreach ($default_tags as $default_tag) {
      ...
      // url for \Drupal\taxons\Controller\VatToggleTagController::toggleTag
      $url = Url::fromRoute('taxons.vat_toggle_tag', [
